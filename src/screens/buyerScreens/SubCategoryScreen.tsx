...
const onPressShedulePlayButtonPressed = () => {
  console.log('the ShedulePlayButton  press');
};
const renderScheduledShowsListItem = ({item}: any) => {
  return (
    <ScheduledShowItem
      ...
      onPressPlayBtn={() => onPressShedulePlayButtonPressed}
    />
  );
};

const onPlayLivePlayButtonPressed = () => {
  console.log('Live play button press ');
};
...
const renderLiveShowListItem = ({item}: any) => {
  return (
    <LiveShowItem
      ...
      subCategoryName={item?.subCategoryName}
      thumbnail={item?.thumbanilUrl}
      onPressPlayBtn={() => onPlayLivePlayButtonPressed}
    />
  );
};
